...
public class ProgressCircle extends View {
    ...
    {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ProgressCircle, defStyle, 0);

        Resources resources = getResources();

        // Initialize attributes from styleable attributes
        currentProgress = a.getFloat(R.styleable.ProgressCircle_cpv_progress,resources.getInteger(R.integer.cpv_default_progress));
        maxProgress = a.getFloat(R.styleable.ProgressCircle_cpv_maxProgress,resources.getInteger(R.integer.cpv_default_max_progress));
        thickness = a.getDimensionPixelSize(R.styleable.ProgressCircle_cpv_thickness,resources.getDimensionPixelSize(R.dimen.cpv_default_thickness));
        isIndeterminate = a.getBoolean(R.styleable.ProgressCircle_cpv_indeterminate,resources.getBoolean(R.bool.cpv_default_is_indeterminate));
        autostartAnimation = a.getBoolean(R.styleable.ProgressCircle_cpv_animAutostart, resources.getBoolean(R.bool.cpv_default_anim_autostart));

        int accentColor = getContext().getResources().getIdentifier("colorClientAccent", "attr", getContext().getPackageName());

        // If color explicitly provided
        if (a.hasValue(R.styleable.ProgressCircle_cpv_color)) {
            color = a.getColor(R.styleable.ProgressCircle_cpv_color, resources.getColor(R.color.cpv_default_color));
        }
        ...
        animDuration = a.getInteger(R.styleable.ProgressCircle_cpv_animDuration,
                resources.getInteger(R.integer.cpv_default_anim_duration));
        animSwoopDuration = a.getInteger(R.styleable.ProgressCircle_cpv_animSwoopDuration,
                resources.getInteger(R.integer.cpv_default_anim_swoop_duration));
        animSyncDuration = a.getInteger(R.styleable.ProgressCircle_cpv_animSyncDuration,
                resources.getInteger(R.integer.cpv_default_anim_sync_duration));
        animSteps = a.getInteger(R.styleable.ProgressCircle_cpv_animSteps,
