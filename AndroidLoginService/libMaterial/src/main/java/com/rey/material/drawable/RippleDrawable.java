...
public class RippleDrawable extends Drawable implements Animatable,	OnTouchListener {
    ...
    private int mAndroidBackgroundColor;
    private int corner;
    ...
    private void drawBk(Canvas canvas) {
        mBkPaint.setColor(mAndroidBackgroundColor);
		int weight=canvas.getWidth();
		int height=canvas.getHeight();
		int maxCorner=Math.min(weight,height)/2;
		int fixCorner=(corner>maxCorner)?maxCorner:corner;
	...
	public static class Builder{
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
            ...
            int type, resId;
            androidBackgroundColor(a.getColor(R.styleable.RippleDrawable_rd_android_backgroundColor, 0));
        ...
        public Builder androidBackgroundColor(int color){
            mAndroidBackgroundColor = color;
            return this;
        }
